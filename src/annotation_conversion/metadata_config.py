...
cell_labels = {
    ...
    'basophilic_band': [code_anatomical_structure, Code('LP65588-3', 'LNC', 'Basophils.band form')], 
    ...
    'degranulated_neutrophilic_metamyelocyte': [code_anatomical_structure, Code('tbd', 'tbd', 'tbd')], 
    'degranulated_neutrophilic_myelocyte': [code_anatomical_structure, Code('tbd', 'tbd', 'tbd')],
    'eosinophilic_band': [code_anatomical_structure, Code('LP65365-6', 'LNC', 'Eosinophils.band form')],
    ...
    'monoblast': [code_anatomical_structure, Code('53945006', 'SCT', 'Monoblast')],
    'monocyte': [code_anatomical_structure, Code('55918008', 'SCT', 'Monocyte')],
    'monocytic_blast': [code_anatomical_structure, Code('tbd', 'tbd', 'tbd')],
    'myeloblast': [code_anatomical_structure, Code('15622002', 'SCT', 'Myeloblast')],
    'myelocytic_blast': [code_anatomical_structure, Code('tbd', 'tbd', 'tbd')],
    'neutrophil_extracellular_trap': [code_anatomical_structure, Code('C180931', 'NCI', 'Neutrophil Extracellular Trap')],
