...
def build_additional_metadata(
    ...
    ds.AcquisitionContextSequence[0].ConceptNameCodeSequence[0].add_new([0x0008, 0x0102], 'SH', 'DCM') # CodingSchemeDesignator
    ds.AcquisitionContextSequence[0].ConceptNameCodeSequence[0].add_new([0x0008, 0x0104], 'LO', 'Comment') # CodeMeaning
